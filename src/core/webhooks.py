...
class WebhookManager:
    ...
    async def _deliver(
        ...
        elif subscription.auth_type == WebhookAuthType.BEARER and subscription.auth_token:
            headers["Authorization"] = f"Bearer {subscription.auth_token}"
        elif subscription.auth_type == WebhookAuthType.API_KEY and subscription.auth_token:
        ...
        try:
            ...
            if response.status_code >= 200 and response.status_code < 300:
                ...
                if delivery.attempts < subscription.max_retries:
                    ...
                    await asyncio.sleep(subscription.retry_delay_seconds * delivery.attempts)
