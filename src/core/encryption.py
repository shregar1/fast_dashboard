...
from typing import (
    Any, Callable, Dict, Generic, List, Optional, Protocol, Set, Type, TypeVar,
...
class FieldEncryption:
    ...
    def encrypt(
        ...
        result = f"{self.VERSION}:{actual_key_id}:" + base64.urlsafe_b64encode(
            nonce + ciphertext
        ).decode()
...
class ModelEncryption:
    ...
    def encrypt_model(self, model: Any, fields: Optional[List[str]] = None) -> Dict[str, Any]:
        """
                ...
                if not self._is_encrypted(value):
                    ...
                    if hasattr(model, "model_config"):
                        ...
                        if field_config and field_config.get("searchable"):
                            data[f"{field}_hash"] = self.encryption.hash_for_search(str(value))
    ...
    def _get_field_config(self, model: Any, field_name: str) -> Optional[Dict[str, Any]]:
